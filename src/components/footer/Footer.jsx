...
const Footer = () => {
  return (
    <div className="w-full h-[100px] sm:h-[70px] bg-purple-600/70 flex flex-col justify-center items-center sm:flex-row sm:justify-center sm:items-center gap-2 sm:gap-6">
